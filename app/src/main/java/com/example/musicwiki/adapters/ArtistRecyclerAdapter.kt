...
import com.example.musicwiki.activities.ArtistDetailsActivity


class ArtistRecyclerAdapter (var data: MutableList<ArtistListResponse>, private val c: Activity, val  tagData :String) :
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        p0.maincard.setOnClickListener {
            val intent = Intent(c, ArtistDetailsActivity::class.java)
