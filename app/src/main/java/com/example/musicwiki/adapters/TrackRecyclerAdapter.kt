...
class TrackRecyclerAdapter (var data: MutableList<TrackListResponse>, private val c: Activity, private val  tagData :String) :
    RecyclerView.Adapter<TrackRecyclerAdapter.ViewHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val inflater = LayoutInflater.from(p0.context)
        val v: View = inflater.inflate(R.layout.top_album_horizontal_itam, p0, false)
        return ViewHolder(v)
    }
