...
class TagREcyclerAdapter(var data: MutableList<TagsListResponse>, private val c: Activity) :
    RecyclerView.Adapter<TagREcyclerAdapter.ViewHolder>() {

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val inflater = LayoutInflater.from(p0.context)
        val v: View = inflater.inflate(R.layout.tag_horizontal_item, p0, false)
        return ViewHolder(v)
    }
